...
public class Configs implements IConfigHandler
{
  ...
  public static class Generic
  {
    ...
    public static final EConfigString ENTITY_DATA_TNT_FORMAT = new EConfigString("getEntityDataTNTFormat",
      "#gold\"%countx \", #light_purple\"TNT\", \" | \", {\"insertion\":\"%x, %y, %z\",\"text\":\"\",\"extra\":[#red\"%x \", #green\"%y \", #blue\"%z\"]}, \" | \", {\"insertion\":\"%mx, %my, %mz\",\"color\":\"yellow\",\"text\":\"%mx %my %mz\"}, \" | \", {\"insertion\":\"%px, %py, %pz\",\"color\":\"aqua\",\"text\":\"%px %py %pz\"}, \" (Fuse \", #light_purple\"%fuse\", \") \", {\"clickEvent\":{\"action\":\"suggest_command\",\"value\":\"/summon tnt %x %y %z {Motion:[%mxd, %myd, %mzd],Fuse:%fuse}\"}, \"color\":\"gold\", \"text\":\"[summon]\"}", "The format for getEntityData when the entity is TNT.\nSee https://github.com/axialeaa/colorful-minihud for how to format\n§6%%%%x, %%%%y, %%%%z: XYZ position\n§6%%%%mx, %%%%my, %%%%mz: XYZ motion\n§6%%%%count: Number of entities in the same state\n§6%%%%fuse: Fuse of the tnt");
  ...
  public enum Renderers
  {
    ...
    EXPLOSION_BLOCK_RAYS     ("explosionBlockRays",      "#FFFF0000", "Minimum color", "#FFFFFF00", "Maximum color", "#FFFF0000", "Ray color",
    ...
    private static ImmutableList<EConfigBoolean> entityPacketRequirers = ImmutableList.of(
      ...
      EXPLOSION_ENTITY_RAYS.config.booleanConfig()
    );
    ...
    private Renderers(String name, String color1, String color1Comment, String color2, String color2Comment, String color3, String color3Comment, String comment, String prettyName)
    {
      config = new EConfigRenderer(name, color1, color1Comment, color2, color2Comment, color3, color3Comment, comment, prettyName);
    }
