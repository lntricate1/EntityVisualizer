...
// import me.lntricate.entityvisualizer.config.options.EConfigStringList;
...
public class Configs implements IConfigHandler
{
  ...
  public enum Lists
  {
    ...
    private Lists(String name, ListContext context, String prettyName)
    {
      ...
      {
        case BLOCKS:
          instantiate(name, ListType.BLACKLIST, ImmutableList.of(), ImmutableList.of("minecraft:air"), prettyName);
          break;
        case ENTITIES:
    ...
    {
      return config.test(Registry.BLOCK.getKey(block).toString());
    }
  }
}
