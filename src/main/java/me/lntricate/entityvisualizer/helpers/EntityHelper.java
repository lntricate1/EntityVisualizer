...
public class EntityHelper
{
  ...
  public static final record Move1(String id, double x, double y, double z, double dx, double dy, double dz,
    double ax, double ay, double az, double by, double cy, boolean xFirst){}
  // Step up, full
  // x, y, z start pos
  // dx, dy, dz first collision
  // ax, ay, az second collision
  // bx, by, bz third collision
  // cy Y of final collision. x and z can be dx,dz, ax,az or bx,bz.
  public static final record Move2(String id, double x, double y, double z, double dx, double dy, double dz,
    double ax, double ay, double az, double bx, double by, double bz, double cy, boolean xFirst){}
